...
function Navbar() {
  ...
  const navLinks = [
    ...
    { path: '/quiz', label: t('nav.legalQuiz') },
              ...
              >
                <Link to={link.path}>
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 relative overflow-hidden ${isActive(link.path)
                      ? 'text-white'
