          ...
          <div className="flex justify-between items-start">
            ...
            >
              <motion.button
                ...
                className="flex items-center space-x-2 bg-white/20 hover:bg-white/30 backdrop-blur-md px-4 py-2 rounded-xl transition-all duration-300 border border-white/30"
              >
              ...
              <AnimatePresence>
                {showLanguageDropdown && (
                  <motion.div
                    ...
                    className="absolute right-0 mt-2 w-48 glass-strong rounded-xl shadow-2xl border border-white/20 z-50 overflow-hidden"
                  >
              ...
              >
                ...
                >
                  ...
                  {message.role === 'assistant' && (
                    ...
                    >
                      <select
                        value={getMessageLang(index)}
                        onChange={(e) => setMessageLang(index, e.target.value)}
                        className="text-xs border border-amber-200 rounded-lg px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500 bg-amber-50/80 backdrop-blur-sm"
                      >
                        {supportedLanguages.map((lang) => (
            ...
            {isListening && (
              ...
              >
                <motion.div
                  ...
                  className="bg-gradient-to-r from-red-500 to-pink-600 text-white rounded-full px-6 py-3 flex items-center space-x-2 shadow-2xl"
                >
                  <motion.div
